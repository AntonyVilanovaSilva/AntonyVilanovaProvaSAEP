...
namespace GerenciamentoTarefaDB.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDUsuario,Nome,Email")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDUsuario,Nome,Email")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
