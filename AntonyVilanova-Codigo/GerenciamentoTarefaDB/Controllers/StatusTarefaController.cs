...
namespace GerenciamentoTarefaDB.Controllers
{
    public class StatusTarefaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdStatus,Descricao")] StatusTarefa statusTarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdStatus,Descricao")] StatusTarefa statusTarefa)
        {
            if (ModelState.IsValid)
            {
